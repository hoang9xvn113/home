 ...
 * @generated
 */
@Component(service = HomeEntryPersistence.class)
public class HomeEntryPersistenceImpl
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, homeEntryModelImpl, false);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", HomeEntry.class.getName()));
		...
		_finderPathWithPaginationFindByAddress = _createFinderPath(
