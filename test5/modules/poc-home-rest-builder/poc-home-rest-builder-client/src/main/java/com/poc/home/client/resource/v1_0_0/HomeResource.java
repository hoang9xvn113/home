package com.poc.home.client.resource.v1_0_0;
...
import com.poc.home.client.problem.Problem;
	...
	public static class HomeResourceImpl implements HomeResource {
		...
		public HttpInvoker.HttpResponse getHomesHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/poc-home-rest-builder/1.0.0/homes");
		...
		public HttpInvoker.HttpResponse deleteHomeByHomeIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/poc-home-rest-builder/1.0.0/homes/{homeId}");
