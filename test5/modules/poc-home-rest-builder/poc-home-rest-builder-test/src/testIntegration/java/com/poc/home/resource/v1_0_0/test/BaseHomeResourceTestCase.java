package com.poc.home.resource.v1_0_0.test;
...
import com.poc.home.client.dto.v1_0_0.Home;
import com.poc.home.client.http.HttpInvoker;
import com.poc.home.client.pagination.Page;
import com.poc.home.client.pagination.Pagination;
import com.poc.home.client.resource.v1_0_0.HomeResource;
...
public abstract class BaseHomeResourceTestCase {
	...
	public void testGetHomes() throws Exception {
		...
		page = homeResource.getHomes(null, null, Pagination.of(1, 10), null);

		Assert.assertEquals(totalCount + 2, page.getTotalCount());

		assertContains(home1, (List<Home>)page.getItems());
		assertContains(home2, (List<Home>)page.getItems());
		assertValid(page);
	}
	...
	public void testGetHomesWithPagination() throws Exception {
		Page<Home> totalPage = homeResource.getHomes(null, null, null, null);
		...
		Assert.assertEquals(homes1.toString(), totalCount + 2, homes1.size());
		...
		assertContains(home1, (List<Home>)page3.getItems());
		assertContains(home2, (List<Home>)page3.getItems());
		assertContains(home3, (List<Home>)page3.getItems());
	}
	...
	public void testGraphQLGetHomes() throws Exception {
		...
		long totalCount = homesJSONObject.getLong("totalCount");
		...
		Assert.assertEquals(
			totalCount + 2, homesJSONObject.getLong("totalCount"));
	...
	public void testUpdateHomeByHomeId() throws Exception {
		Home postHome = testUpdateHomeByHomeId_addHome();

		Home randomHome = randomHome();

		Home putHome = homeResource.updateHomeByHomeId(postHome.getId(), null);

		assertEquals(randomHome, putHome);
		assertValid(putHome);

		Home getHome = homeResource.updateHomeByHomeId(putHome.getId());

		assertEquals(randomHome, getHome);
		assertValid(getHome);
	}

	protected Home testUpdateHomeByHomeId_addHome() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	protected void assertContains(Home home, List<Home> homes) {
		...
		Assert.assertTrue(homes + " does not contain " + home, contains);
	}
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(com.poc.home.dto.v1_0_0.Home.class)) {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseHomeResourceTestCase.class);
	...
	@Inject
	private com.poc.home.resource.v1_0_0.HomeResource _homeResource;
