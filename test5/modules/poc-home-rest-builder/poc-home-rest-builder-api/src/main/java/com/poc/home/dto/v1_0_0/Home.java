package com.poc.home.dto.v1_0_0;
...
public class Home implements Serializable {
	...
	public static Home unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Home.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.poc.home.dto.v1_0_0.Home", name = "x-class-name"
	)
