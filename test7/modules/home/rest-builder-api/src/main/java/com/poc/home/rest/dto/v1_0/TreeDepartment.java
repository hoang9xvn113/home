 ...
 */
@Generated("")
@GraphQLName(description = "A very simple department", value = "TreeDepartment")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TreeDepartment")
public class TreeDepartment implements Serializable {

	public static TreeDepartment toDTO(String json) {
		return ObjectMapperUtil.readValue(TreeDepartment.class, json);
	}
	...
	public String toString() {
		...
		if (treeDepartments != null) {
			...
			for (int i = 0; i < treeDepartments.length; i++) {
				sb.append(String.valueOf(treeDepartments[i]));

				if ((i + 1) < treeDepartments.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.poc.home.rest.dto.v1_0.TreeDepartment",
		name = "x-class-name"
	)
