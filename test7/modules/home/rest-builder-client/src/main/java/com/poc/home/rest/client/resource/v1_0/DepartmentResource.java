...
public interface DepartmentResource {
	...
	public HttpInvoker.HttpResponse getDepartmentsHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse addDepartmentHttpResponse(
	...
	public static class DepartmentResourceImpl implements DepartmentResource {
		...
		public HttpInvoker.HttpResponse deleteDepartmentHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/rest-builder/v1.0/departments/{departmentId}");
		...
		public HttpInvoker.HttpResponse deleteDepartmentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/rest-builder/v1.0/departments/batch");
		...
		public Page<Department> getDepartments(
			...
			HttpInvoker.HttpResponse httpResponse = getDepartmentsHttpResponse(
		...
		public HttpInvoker.HttpResponse getDepartmentsHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/rest-builder/v1.0/departments");
		...
		public Department addDepartment(Department department)
			...
			HttpInvoker.HttpResponse httpResponse = addDepartmentHttpResponse(
				department);
