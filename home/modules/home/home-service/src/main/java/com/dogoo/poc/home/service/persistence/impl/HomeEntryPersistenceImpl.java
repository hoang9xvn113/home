...
package com.dogoo.poc.home.service.persistence.impl;

import com.dogoo.poc.home.exception.NoSuchHomeEntryException;
import com.dogoo.poc.home.model.HomeEntry;
import com.dogoo.poc.home.model.HomeEntryTable;
import com.dogoo.poc.home.model.impl.HomeEntryImpl;
import com.dogoo.poc.home.model.impl.HomeEntryModelImpl;
import com.dogoo.poc.home.service.persistence.HomeEntryPersistence;
import com.dogoo.poc.home.service.persistence.impl.constants.DGPersistenceConstants;
...
public class HomeEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByAddress;
	private FinderPath _finderPathWithoutPaginationFindByAddress;
	private FinderPath _finderPathCountByAddress;

	/**
	 * Returns all the home entries where address = &#63;.
	 *
	 * @param address the address
	 * @return the matching home entries
	 */
	@Override
	public List<HomeEntry> findByAddress(String address) {
		return findByAddress(
			address, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the home entries where address = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>HomeEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<HomeEntry> findByAddress(String address, int start, int end) {
		return findByAddress(address, start, end, null);
	}

	/**
	 * Returns an ordered range of all the home entries where address = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>HomeEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<HomeEntry> findByAddress(
		String address, int start, int end,
		OrderByComparator<HomeEntry> orderByComparator) {

		return findByAddress(address, start, end, orderByComparator, true);
	}
	...
	public List<HomeEntry> findByAddress(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByAddress;
				finderArgs = new Object[] {address};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByAddress;
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (HomeEntry homeEntry : list) {
					if (!address.equals(homeEntry.getAddress())) {
						list = null;
	...
	/**
	 * Returns the first home entry in the ordered set where address = &#63;.
	 *
	 * @param address the address
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching home entry
	 ...
	 */
	@Override
	public HomeEntry findByAddress_First(
			String address, OrderByComparator<HomeEntry> orderByComparator)
		throws NoSuchHomeEntryException {

		HomeEntry homeEntry = fetchByAddress_First(address, orderByComparator);
	 ...
	 */
	@Override
	public HomeEntry fetchByAddress_First(
		String address, OrderByComparator<HomeEntry> orderByComparator) {

		List<HomeEntry> list = findByAddress(address, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last home entry in the ordered set where address = &#63;.
	 *
	 * @param address the address
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching home entry
	 ...
	 */
	@Override
	public HomeEntry findByAddress_Last(
			String address, OrderByComparator<HomeEntry> orderByComparator)
		throws NoSuchHomeEntryException {

		HomeEntry homeEntry = fetchByAddress_Last(address, orderByComparator);
	 ...
	 */
	@Override
	public HomeEntry fetchByAddress_Last(
		String address, OrderByComparator<HomeEntry> orderByComparator) {
		...
		List<HomeEntry> list = findByAddress(
			address, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the home entries before and after the current home entry in the ordered set where address = &#63;.
	 *
	 * @param homeId the primary key of the current home entry
	 * @param address the address
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public HomeEntry[] findByAddress_PrevAndNext(
			long homeId, String address,
			OrderByComparator<HomeEntry> orderByComparator)
		throws NoSuchHomeEntryException {
		...
		try {
			...
			array[0] = getByAddress_PrevAndNext(
				session, homeEntry, address, orderByComparator, true);

			array[1] = homeEntry;

			array[2] = getByAddress_PrevAndNext(
				session, homeEntry, address, orderByComparator, false);
	...
	protected HomeEntry getByAddress_PrevAndNext(
		Session session, HomeEntry homeEntry, String address,
		OrderByComparator<HomeEntry> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the home entries where address = &#63; from the database.
	 *
	 * @param address the address
	 */
	@Override
	...
	/**
	 * Returns the number of home entries where address = &#63;.
	 *
	 * @param address the address
	 * @return the number of matching home entries
	 */
	...
	private static final String _FINDER_COLUMN_ADDRESS_ADDRESS_3 =
		"(homeEntry.address IS NULL OR homeEntry.address = '')";
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new HomeEntryModelArgumentsResolver(),
		...
		_finderPathWithPaginationFindByAddress = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByAddress",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"address"}, true);

		_finderPathWithoutPaginationFindByAddress = new FinderPath(
	...
	private static class HomeEntryModelArgumentsResolver
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						homeEntryModelImpl.getColumnBitmask(columnName);
				}
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = homeEntryModelImpl.getColumnValue(
						columnName);
				}
			}
