package com.poc.home.rest.internal.resource.v1_0_0.factory;
...
public class HomeResourceFactoryImpl implements HomeResource.Factory {
	...
	public HomeResource.Builder create() {
		return new HomeResource.Builder() {
			...
			@Override
			public HomeResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		homeResource.setContextHttpServletResponse(httpServletResponse);
		homeResource.setContextUser(user);
		homeResource.setExpressionConvert(_expressionConvert);
		homeResource.setFilterParserProvider(_filterParserProvider);
		homeResource.setGroupLocalService(_groupLocalService);
		homeResource.setResourceActionLocalService(_resourceActionLocalService);
		homeResource.setResourcePermissionLocalService(
